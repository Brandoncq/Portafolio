              ...
              <div className="xl:w-1/5 lg:w-1/3 p-1 m-0 flex flex-col justify-center items-center">
                ...
                >
                  <svg
                    ...
                    height="68"
                    viewBox="0 0 50 50"
                    className="p-px cursor-pointer w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 fill-white hover:fill-zinc-300 ease-in-out transition-all duration-300"
                  >
            ...
            <div className="lg:w-1/3 w-4/5  flex flex-wrap justify-center">
              <div className="lg:w-1/3 w-1/2 p-1">
                <div className="lg:text-xl text-lg w-full bg-black rounded-xl font-bold text-center shadow-md shadow-white hover:shadow-zinc-700">
                  <NavLink
                    className="cursor-pointer bg-black text-zinc-200 hover:bg-white hover:text-black block py-3 rounded-xl transition-all duration-300 ease-in-out"
                    to="/Proyectos"
