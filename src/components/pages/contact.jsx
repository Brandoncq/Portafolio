...
export const Contact = () => {
  return (
    <div className="w-full flex flex-wrap  min-h-screen bg-custom-contact">
      <div className="w-full flex p-1 flex-col justify-center items-center h-full absolute z-10">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-1/3 flex p-10 justify-center items-center">
            <div className="xl:w-1/5 lg:w-1/3 p-1 m-0 flex flex-col justify-center items-center">
              ...
              >
                <svg
                  ...
                  height="68"
                  viewBox="0 0 50 50"
                  className="redes p-2 cursor-pointer"
                >
                  <path
                    className="svg-360"
            ...
            <div className="xl:w-1/5 lg:w-1/3 p-1 m-0 flex flex-col justify-center items-center">
              ...
              >
                ...
                >
                  <path
                    className="svg-360"
                    d="M9 4C6.25 4 4 6.25 4 9v32c0 2.75 2.25 5 5 5h32c2.75 0 5-2.25 5-5V9c0-2.75-2.25-5-5-5H9zm0 2h32c1.668 0 3 1.332 3 3v32c0 1.668-1.332 3-3 3H9c-1.668 0-3-1.332-3-3V9c0-1.668 1.332-3 3-3zm2 10a1 1 0 00-1 1v16.002a1 1 0 001 1h7.61a1 1 0 00.001 0c.413 0 1.86-.036 3.356-.738C23.463 32.56 25 30.98 25 28.428c0-1.62-.53-2.84-1.242-3.643-.298-.336-.576-.373-.89-.58C23.468 23.501 24 22.548 24 21c0-2.383-1.305-3.861-2.646-4.463-1.342-.601-2.721-.537-3.061-.537H11zm19 0a1 1 0 100 2h6a1 1 0 100-2h-6zm-18 2h6.293c.452 0 1.428-.004 2.242.361C21.35 18.726 22 19.25 22 21c0 1.876-.723 2.236-1.152 2.457a1 1 0 00.132 1.834c.379.13.884.371 1.282.82.398.45.738 1.108.738 2.317 0 1.83-.843 2.537-1.883 3.025s-2.286.549-2.508.549H12V18zm21 1c-.912 0-2.583.181-4.137 1.248C27.31 21.315 26 23.339 26 26.5c0 2.943 1.209 4.944 2.729 6.068C30.249 33.693 31.97 34 33.169 34c2.54 0 4.335-.863 5.411-2.09.994-1.133 1.322-2.47 1.373-3.613a1 1 0 00.047-.262l-.002-.027L40 28a1 1 0 00-.006-.1 1 1 0 000-.004c.055-1.807-.085-3.896-1.05-5.683C37.953 20.382 35.966 19 33 19zm-18 1v3h2.62c.356 0 1.546-.225 1.546-1.564 0-1.34-1.548-1.436-1.785-1.436H15zm18 1c2.408 0 3.483.868 4.182 2.162.566 1.048.738 2.456.771 3.838H31a1 1 0 00-1 1s.009.252.082.473c.073.22.218.491.461.734.486.486 1.29.793 2.457.793 1.167 0 1.971-.307 2.457-.793.069-.069.077-.136.13-.207h2.255c-.133.555-.347 1.112-.766 1.59-.678.773-1.797 1.41-3.906 1.41-.829 0-2.194-.257-3.252-1.04C28.86 30.179 28 28.93 28 26.5c0-2.646.93-3.872 1.996-4.604C31.062 21.165 32.391 21 33 21zm.086 1.602c-.591 0-1.016.075-1.354.23-.338.154-.59.387-.843.62-.17.231-.34.465-.424.775-.085.232-.17.464-.168.775h5.408c-.085-.775-.339-1.394-.762-1.781-.422-.387-1.012-.62-1.857-.62zM15.033 26v3.98h2.93c.254 0 2.037-.098 2.037-1.916C20 26.244 18.599 26 17.963 26h-2.93z"
                  ></path>
                </svg>
              </a>
            </div>
